CREATE DATABASE customer_service_db WITH OWNER=postgres ENCODING='UTF8' CONNECTION LIMIT = -1;
COMMENT ON DATABASE customer_service_db IS 'customer-service database';
...
COMMENT ON DATABASE payment_service_db IS 'payment-service database';
